...
def main():
    ...
    with st.sidebar:
        ...
        # Slack API option
            ...
            if st.button("Fetch from Slack", use_container_width=True):
                if not slack_token or not channel_id:
                    ...
                    with st.spinner("Fetching messages from Slack..."):
                        app.raw_chats = fetch_slack_messages(slack_token, channel_id, message_limit)
            ...
            if hasattr(st.session_state, 'slack_data') and not app.raw_chats:
                app.raw_chats = st.session_state.slack_data
...
# Additional helper function for EnhancedChatApp class
def add_slack_parsing_method_to_app():
    """
    Add this method to your EnhancedChatApp class if needed for additional Slack-specific parsing
    """
    def parse_slack_data(self, slack_messages):
        """
        Parse Slack API response format into app format
        """
        parsed_messages = []
        ...
        for msg in slack_messages:
            ...
            parsed_msg = {
                ...
                "message": msg.get("text", ""),
                "thread_ts": msg.get("thread_ts"),  # For threading support
                "reactions": msg.get("reactions", [])  # For reaction analysis
            }
